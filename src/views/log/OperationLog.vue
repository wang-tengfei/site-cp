...
<!--              <el-input v-model="searchData.type"></el-input>-->
    ...
    <div class="data-info role-info">
      <el-table :data="tableData" border width="100%" size="small" fit stripe highlight-current-row>
        ...
        <el-table-column prop="desc" label="描述" min-width="150px"></el-table-column>
        <el-table-column prop="logStatus" label="状态" width="70px">
          <template  slot-scope="scope">
            <span v-if="scope.row.logStatus === 0">成功</span>
            <span v-if="scope.row.logStatus === 1" style="color: red">失败</span>
          </template>
        </el-table-column>
        <el-table-column prop="createTime"  min-width="80px" label="创建日期" :formatter="formatterDate"></el-table-column>
      </el-table>
      <div class="block">
